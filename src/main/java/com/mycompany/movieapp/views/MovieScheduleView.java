...
public class MovieScheduleView extends javax.swing.JDialog {
    ...
    /**
     * Create a panel for displaying schedule information
     */
    private javax.swing.JPanel createSchedulePanel(Schedule schedule, 
        ...
        // Add click listener to open booking page
    ...
    /**
     * Open booking page for selected schedule
     */
    private void openBookingPage(Schedule schedule) {
        ...
        this.dispose(); // Close schedule view when opening booking page
    }
